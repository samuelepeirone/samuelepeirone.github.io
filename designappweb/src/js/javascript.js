    ...
    var config = {
      ...
      data: {
        ...
        datasets: [
          ...
          {
            label: "Concentrazione di Benzene nell'aria",
            data: valueAirTox,
...
function assigndatacanvas() {
  if (document.getElementById("tuttibutton").disabled == false) {
    document
      .getElementById("tuttibutton")
      .classList.add("buttoncanvasselected");
    ...
    document
      .getElementById("nordbutton")
      .classList.remove("buttoncanvasselected");
...
request2.open(
  "GET",
  "https://samuelepeirone.github.io/data_eurostat/eu_waste.json",
  true
);
request2.send();
...
request3.open(
  "GET",
  "https://samuelepeirone.github.io/data_eurostat/eu_waste_data.json",
  true
);
request3.send();
...
function cambiastilelista() {
  ...
  if (width > 996) {
    document
      .getElementsByClassName("mydata")[0]
      .classList.add("primarigasoldi");
  } else {
    document
      .getElementsByClassName("mydata")[0]
      .classList.remove("primarigasoldi");
  }
}
//----------------------------------------------ABOUTUS------------------------------
