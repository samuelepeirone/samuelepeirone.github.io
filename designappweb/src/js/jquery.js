...
function caroselloimmagini() {
  const arraysources = [
    "../assets/img/carousel_img/carousel1.jpg",
    "../assets/img/carousel_img/carousel2.jpg",
    "../assets/img/carousel_img/carousel3.jpg",
    "../assets/img/carousel_img/carousel4.jpg",
    "../assets/img/carousel_img/carousel5.jpg",
  ];
  const arrayparagraphs = [
    "Crediamo nei sogni e nella possibilità di realizzarli grazie ad un insieme di sforzi collettivi",
  ...
  const arrayalt = [
    "Ingresso di un teatro, la cui insegna recita 'Dreamland', la Città dei sogni in Inglese",
    "Vista dall'alto di un deserto, dal quale si innalzano un grandissimo numero di mongolfiere colorate.",
    "Immagine di una folla ad un concerto, in movimento e con le mani alzate",
    "Vista di un edificio posto su una scogliera, sulla parte più esterna del quale si abbattono le onde",
